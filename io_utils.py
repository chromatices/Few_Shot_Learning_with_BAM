...
def parse_args(script):
    ...
    parser.add_argument('--dataset'     , default='CUB',        help='CUB/miniImagenet/cross/plant/cross_novel/omniglot/cross_char/')
    ...
    parser.add_argument('--gpu_num'     , default='0', type=str,  help='define of gpu numbering')
    parser.add_argument('--bam'     , default='true', type=str,  help='determine using combined backbone network with bam')
    if script == 'train':
